...
export default function Dashboard() {
  ...
  return (
    <div className="flex h-screen bg-gray-100">
      ...
      {/* Main content */}
      <div className="flex-1 p-10 ml-64 md:ml-0">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 style">
          {/* Sales vs Orders Chart */}
          <div className="bg-white p-6 rounded-lg shadow sub">
            <h2 className="text-lg font-semibold mb-4">Sales vs Orders <span className="text-gray-400">ⓘ</span></h2>
          ...
          <div className="bg-white p-6 rounded-lg shadow sub">
            <h2 className="text-lg font-semibold mb-4 ">Portion of Sales <span className="text-gray-400">ⓘ</span></h2>
            <ResponsiveContainer width="100%" height={300}>
              <PieChart>
